...
export const CHANGELOG: ChangelogEntry[] = [
  // ── 2026-05-15 — mermaidAlt rewrite pass (24 patterns) + funnel-method retired ──
  {
    date: '2026-05-15',
    slug: 'funnel-method',
    type: 'retired',
    note: 'Retire pattern from active catalog; file archived with archived: true; index and sibling cross-links cleaned.',
    author: 'julianken',
  },
  {
    date: '2026-05-15',
    ...
    type: 'edited',
    note: 'Rewrite mermaidAlt as self-contained pattern definition (mechanism + contrast).',
    author: 'julianken',
  },
  {
    date: '2026-05-15',
  ...
  // ── 2026-05-05 entries (preserved append-only) ──────────────────────────────
  {
    date: '2026-05-05',
    slug: 'funnel-method',
    type: 'added',
