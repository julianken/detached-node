...
export const pattern: Pattern = {
  ...
  whenToUse: [
    ...
    'Worth the cost when the cost of an extra retrieval is small relative to the cost of an unsupported answer (research assistants, regulatory or medical Q&A, customer-facing support that escalates on uncertainty).',
  ...
  realWorldExamples: [
    ...
    {
      text: "Anthropic's web_search tool lets a Claude model decide mid-trajectory to issue one or more searches, read the results, and either answer or search again. The pattern is documented as a first-party tool the model invokes inside a normal tool-use loop.",
      sourceUrl: 'https://platform.claude.com/docs/en/agents-and-tools/tool-use/web-search-tool',
    },
    {
      text: "LangGraph's agentic-RAG tutorial wires a graph in which the model first decides whether to retrieve, then grades the retrieved passages, and either rewrites the query and re-retrieves or generates an answer. It implements the iterative control flow this pattern names, runnable end-to-end.",
