...
export const pattern: Pattern = {
  ...
  whenToUse: [
    ...
    'A good fit when cost or latency is the binding constraint and a small model can correctly handle most traffic, leaving the frontier model for the residual where quality regresses.',
    'Useful when each handler has different tool, data, or permission scopes. Keeping refund logic out of the technical-support tool surface is easier with separate paths than with a single prompt and conditional tool gating.',
  ],
  whenNotToUse: [
