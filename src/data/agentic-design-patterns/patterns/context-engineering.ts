...
export const pattern: Pattern = {
  ...
  whenToUse: [
    ...
    'A good fit when accuracy depends on which evidence the model attends to, not just on whether the evidence is in the prompt at all (long-context recall degrades by position).',
