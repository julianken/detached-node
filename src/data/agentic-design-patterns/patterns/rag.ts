...
export const pattern: Pattern = {
  ...
  whenToUse: [
    ...
    'A good fit when hallucination cost is high and you need an inspectable audit trail: every cited claim points back to a specific chunk in a specific document.',
  ...
  realWorldExamples: [
    {
      text: 'Perplexity issues a search for every conversational turn, retrieves a few pages of results, and conditions its answer on those passages with inline citations. The product is consumer-facing RAG with a UI that exposes the retrieved sources next to each claim.',
