...
export const pattern: Pattern = {
  ...
  layerId: 'quality',
  oneLineSummary: 'Scores model outputs with a stronger LLM applying a written rubric.',
  bodySummary: [
  ...
  whenToUse: [
    ...
    'A good fit when you need pairwise leaderboards or A/B regression tracking across many candidate models, prompts, or RAG configurations on the same eval set.',
