...
export function ScrollPillNav() {
  ...
  return (
    ...
    >
      <div
        ref={innerRef}
        className="relative mx-auto flex max-w-frame items-center gap-4 rounded-full border border-border bg-background/90 px-4 py-2 shadow-sm backdrop-blur-md sm:gap-5 sm:px-5 data-[glitching]:animate-[pill-theme-jitter_280ms_steps(5,jump-end)_forwards]"
      >
        <Link
          href="/"
