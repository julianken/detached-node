...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_posts_type" AS ENUM('essay', 'decoder', 'index', 'field-report');
  ...
  CREATE TABLE "posts" (
  	...
  	"title" varchar NOT NULL,
  	"slug" varchar NOT NULL,
  	"type" "enum_posts_type" DEFAULT 'essay' NOT NULL,
  ...
  CREATE INDEX "listings_featured_image_idx" ON "listings" USING btree ("featured_image_id");
  ...
  CREATE INDEX "listings_rels_posts_id_idx" ON "listings_rels" USING btree ("posts_id");
