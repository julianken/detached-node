...
async function seedTestDatabase() {
  ...
  const post2 = await payload.create({
    ...
    data: {
      ...
      featuredImageLight: mediaItems[1].id,
      featuredImageDark: mediaItems[1].id,
      body: createRichTextMulti([
  ...
  const post3 = await payload.create({
    ...
    data: {
      ...
      featuredImageLight: mediaItems[2].id,
      featuredImageDark: mediaItems[2].id,
      body: createRichTextMulti([
  ...
  const post4 = await payload.create({
    ...
    data: {
      ...
      featuredImageLight: mediaItems[3].id,
      featuredImageDark: mediaItems[3].id,
      body: createRichTextMulti([
